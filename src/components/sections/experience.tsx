        ...
        <div className="space-y-0">
          {experiences.map((item) => (
            <motion.article
              ...
              variants={fadeUp}
              className="group relative flex gap-4 pb-10 last:pb-3 sm:gap-6"
            >
              {/* Node */}
              <div className="relative z-[1] mt-1.5 flex w-4 shrink-0 justify-center sm:w-5">
                <span
                  className="h-2 w-2 rounded-full border-2 border-[hsl(var(--background))] bg-primary shadow-[0_0_10px_hsl(var(--primary)_/_0.35)] ring-1 ring-primary/30 transition group-hover:scale-110 group-hover:shadow-[0_0_14px_hsl(var(--primary)_/_0.45)]"
                  aria-hidden
                />
              </div>

              <div className="min-w-0 flex-1 border-b border-border/70 pb-10 transition-colors group-hover:border-primary/25 last:border-0 last:pb-3">
